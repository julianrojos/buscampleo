      ...
      >
        ...
        {showCloseButton && (
          <SheetPrimitive.Close
            ...
            className="absolute top-4 right-4 inline-flex size-9 items-center justify-center rounded-none border border-border bg-background text-muted-foreground transition-colors hover:bg-muted hover:text-foreground"
          >
            <XIcon />
